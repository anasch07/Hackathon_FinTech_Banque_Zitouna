...
const FooterThree = ({
    ...
    return ( <
        ...
        div className = "row" >
        <
        div className = "col-lg-2 col-sm-4" > { /* footer copyright */ } <
        ...
        /div> <
        /div> <
        div className = "col-lg-4 col-sm-6" > { /* footer newsletter */ } <
        FooterNewsletter spaceBottomClass = "mb-30"
        ...
        /div> <
        /div> <
        button className = { `scroll-top ${scroll > top ? "show" : ""}` }
        onClick = {
            () => scrollToTop() } >
        <
