          ...
          sliderClassName ? sliderClassName : ""
            ...
            /Link> {
                ...
                title = "Quick View" >
                    ...
                    h3 >
                    <
                    Link to = { process.env.PUBLIC_URL + "/product/" + product.id } > { product.name } <
                    /Link> <
                    /h3> {
                    ...
                    div className = "product-price" > {
                        discountedPrice !== null ? ( <
                            Fragment >
                            <
                            span > { "TND " + finalDiscountedPrice } < /span>{" "} <
                            span className = "old" > { "Tnd " + finalProductPrice } <
                            /span> <
                            /Fragment>
                        ) : ( <
                            span > { "Tnd " + finalProductPrice } < /span>
                        )
                    } <
                    /div> <
                    /div> <
